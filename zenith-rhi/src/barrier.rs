...
impl TextureLayout {
    pub fn to_vk(self) -> vk::ImageLayout {
        match self {
            ...
            TextureLayout::DepthStencilAttachmentOptimal => vk::ImageLayout::DEPTH_STENCIL_ATTACHMENT_OPTIMAL,
            TextureLayout::PresentSrcKhr => vk::ImageLayout::PRESENT_SRC_KHR,
        }
    }
}
...
impl From<TextureState> for TextureLayout {
    fn from(value: TextureState) -> Self {
        match value {
            ...
            TextureState::TransferSrc => TextureLayout::TransferSrcOptimal,
            TextureState::TransferDst => TextureLayout::TransferDstOptimal,
            TextureState::Sampled => TextureLayout::ShaderReadOnlyOptimal,
            TextureState::Storage => TextureLayout::General,
            TextureState::General => TextureLayout::General,
            TextureState::Color => TextureLayout::ColorAttachmentOptimal,
            TextureState::DepthStencil => TextureLayout::DepthStencilAttachmentOptimal,
            TextureState::Present => TextureLayout::PresentSrcKhr,
        }
    }
}
    ...
    pub fn to_vk(&self) -> vk::ImageMemoryBarrier2<'a> {
        ...
        vk::ImageMemoryBarrier2::default()
            ...
            .subresource_range(vk::ImageSubresourceRange {
                aspect_mask: self.texture.aspect(),
                base_mip_level: 0,
